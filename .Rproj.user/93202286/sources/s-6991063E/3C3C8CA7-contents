...
# Define high use column, if alc_use is higher than 2:
...
# The data contains now 382 observations and 35 variables, as it should.
...
glimpse(alc_check)
# Everything is in order, 382 observations and 35 variables.